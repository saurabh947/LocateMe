...
import com.locateme.camera.CameraManager;
import com.locateme.camera.ShutterButton;
import com.locateme.language.LanguageCodeHelper;
import com.locateme.language.TranslateAsyncTask;
...
//  }
  ...
  public void confirmLocation(View view){
	  Intent intent = new Intent(this, DestLocation.class);
	  intent.putExtra("sourceLoc", ocrResultView.getText().toString());
	  startActivity(intent);
  }
